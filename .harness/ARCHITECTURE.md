...
| token_hash | varchar  | unique, 토큰 해시     |
...
| preview_object_key | varchar  | nullable, 공개 미리보기 객체 |
| original_object_key | varchar  | 비공개 원본 객체             |
| original_filename  | varchar  | 업로드 원본 파일명           |
| content_type       | varchar  | MIME type                    |
| file_size          | bigint   | byte 단위                    |
| price_credit       | int      |                              |
| ai_tool            | varchar  | nullable                     |
| license_type       | varchar  | PERSONAL / COMMERCIAL        |
| status             | varchar  | PUBLISHED / DELETED          |
| view_count         | bigint   | 상세 조회 시 증가            |
| created_at         | datetime |                              |
| updated_at         | datetime | nullable                     |
...
| ------------- | -------- | -------------------------------- |
| id            | bigint   | PK                               |
| name          | varchar  | unique, CategoryName enum string |
| slug          | varchar  | unique                           |
| display_order | int      | 목록 표시 순서                   |
| active        | boolean  | 신규 콘텐츠 선택 가능 여부      |
| created_at    | datetime |                                  |
| updated_at    | datetime | nullable                         |
...
| code          | varchar  | unique             |
| name          | varchar  | 표시 이름          |
| credit_amount | int      | 기본 지급 크레딧   |
| bonus_credit  | int      | 추가 지급 크레딧   |
| price         | int      | KRW                |
| display_order | int      | 목록 표시 순서     |
...
CREATE TABLE `asset` (
	...
	`preview_object_key` varchar NULL,
	`original_object_key` varchar NOT NULL,
...
CREATE TABLE `category` (
	`id` bigint NOT NULL,
	`name` varchar NOT NULL COMMENT 'unique, CategoryName enum string',
	`slug` varchar NOT NULL COMMENT 'unique',
...
CREATE TABLE `credit_product` (
	`id` bigint NOT NULL,
	`code` varchar NOT NULL COMMENT 'unique',
	`name` varchar NOT NULL,
	`credit_amount` int NOT NULL,
	`bonus_credit` int NOT NULL,
	`price` int NOT NULL,
	`display_order` int NOT NULL,
	`status` varchar NOT NULL,
	`created_at` datetime NOT NULL
...
CREATE TABLE `user` (
	...
	`nickname` varchar NOT NULL COMMENT 'unique',
...
CREATE TABLE `refresh_token` (
	...
	`token_hash` varchar NOT NULL COMMENT 'unique',
