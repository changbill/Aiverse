...
3. Repository 인터페이스(`com.example.aiverse.repository`)의 기본 골격을 정의한다 (구체적인 쿼리 메서드는 api-builder가 필요에 따라 추가).
...
- 출력: `backend/src/main/java/com/example/aiverse/entity/*.java`, 필요 시 `backend/src/main/java/com/example/aiverse/repository/*.java`, `backend/src/main/resources/application.yaml` 갱신
